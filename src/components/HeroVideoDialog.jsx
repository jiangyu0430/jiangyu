...
export function HeroVideoDialog({
  ...
  // Mount-once effect for keyboard event and scroll lock cleanup
  useEffect(() => {
          ...
          {isVideoOpen && (
            ...
            >
              ...
              >
                <motion.button
                  onClick={() => setIsVideoOpen(false)}
                  className="absolute -top-16 right-0 z-[100000] rounded-full bg-neutral-900/70 p-2 text-white/60 hover:text-white ring-1 ring-white/40 backdrop-blur-md hover:bg-neutral-800"
                >
                  <XIcon className="size-5" />
                </motion.button>
                <div className="relative isolate z-[1] size-full overflow-hidden rounded-2xl border-2 border-white bg-background">
                  {shouldRenderIframe && (
                    <iframe
                      src={videoSrc}
