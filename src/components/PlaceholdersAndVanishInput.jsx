...
import { AnimatePresence, motion } from 'framer-motion' // 这里改为 framer-motion
import { useCallback, useEffect, useRef, useState } from 'react'
import { cn } from '../lib/utils'
import emailjs from '@emailjs/browser'

export function PlaceholdersAndVanishInput({ placeholders, onChange }) {
        ...
        <AnimatePresence mode="wait">
          {!value && (
            <motion.p
              ...
              className="absolute left-6 text-zinc-500 text-base font-normal text-left truncate"
            >
